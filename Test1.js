 ...
 checkIfEntityExists('vhacrm_userprovision', function(entityExists) {
	  ...
	  var popupHtml = `  
	    <style>       
	 	...
	 	.commonPopup-header1 { background-color: #002050; color: white; padding: 10px; border-radius: 10px 10px 0 0; font-size: 18px; display: flex; justify-content: center; align-items: center; }
		.button-container { padding: 20px; width: 380px; }
  		.popup button { display: block; width: 100%; margin-bottom: 10px; padding: 10px; background-color: #0c2f5b; color: white; border: none; border-radius: 20px; cursor: pointer; transition: all 0.3s ease; box-shadow: 0 5px 15px rgba(0, 0, 0, 0.2); }
