function fetchEntityFields() {
    ...
    // Assume closeIframe() is defined elsewhere
    closeIframe();
    ...
    xhr.onreadystatechange = function() {
        ...
        if (this.readyState === 4) {
            ...
            if (this.status === 200) {
                ...
                var html = `<div class="securityPopup-header">Copy User Security</div>
                            <div id="securityTooltip" class="securityTooltip">i
                                <span class="securityTooltipText" id="securityTooltiptext">This tool allows you to copy Business Unit, Teams, and Security Roles from one user to another.</span>
                            </div>
                            <style>${securityPopupCss}</style>
                            <div class="securityPopup-row">
                                <div class="section content-section" id="section1">${fieldList}</div>
                            </div>`;
