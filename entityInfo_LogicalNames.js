		...
		if (this.readyState === 4) {
			if (this.status === 200) {
				...
				var fieldList = results.value
					...
					.join('');
				        var html = '<h2 style="text-align: center;">Entity: ' + entityName + '</h2><h2 style="text-align: center;">Record ID: ' + entityId + '</h2><h2 style="text-align: left;">Fields:</h2><br><ul style="columns: 2; -webkit-columns: 2; -moz-columns: 2;">' + fieldList + '</ul>';				
